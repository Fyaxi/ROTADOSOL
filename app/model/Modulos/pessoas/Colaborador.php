...
class Colaborador extends TRecord
{
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('salario_inicio');
        parent::addAttribute('salario_fim');

        parent::addAttribute('GrupoPagamento_id');
    }
    ...
    public function delete($id = null)
    {
        ...
        PessoaPapel::where('pessoa_ids', '=', $this->id)->delete();
        parent::delete($id);
    }

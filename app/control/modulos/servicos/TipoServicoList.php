...
class TipoServicoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Tipos de Itens');
        ...
        $this->form->addActionLink('Inserir Tipo de Item', new TAction(['TipoServicoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');

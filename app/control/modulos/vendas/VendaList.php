...
class VendaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        {
            $criteria = new TCriteria;
            $criteria->add(new TFilter('origem', '=', 'V'), TExpression::OR_OPERATOR);
            $this->setCriteria($criteria); // define a standard filter 
        }
        //////////////////////////////////////////////////////////////////
        //////////////////////////////////////////////////////////////////
        ...
        $this->form->addActionLink('Inserir Venda Teste', new TAction(['CaixaVendaForm', 'onEdit']), 'fa:plus green');
        ...
        $column_financeiro_gerado->setTransformer( function($value, $object) {
            ...
            TTransaction::open('DBUNIDADE');
            $pega_caixa = Caixa::find($object->caixa);
            TTransaction::close();
            ...
            if( $parametroRotinaCaixa->valor == 1)
            {
                if ($pega_caixa->aberto == 'N' AND $pega_caixa->situacao == 'F')
                {
                    $value = 'Faturamento Gerado';
                    $label = 'warning';
                }
            }
            //////////////////////////////////////////////////////////////////
        ...
        $action1 = new TDataGridAction(['VendaForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);

...
class TipoProdutoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_TipoProduto');
        ...
        $this->form->addActionLink('Inserir Tipo de Produto', new TAction(['TipoProdutoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['TipoProdutoForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);

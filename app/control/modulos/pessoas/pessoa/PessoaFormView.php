...
class PessoaFormView extends TPage
{
    ...
    public function onEdit($param)
    {
        try
        {
            ...
            $this->detail_list_contratos->addAction($action1, 'Visualizar',   'fa:eye blue');
            ...
            $panel = new TPanelGroup('Últimos Contratos', '#f5f5f5');
            ...
            $items = ContaReceber::where('pessoa_id', '=', $master_object->id)->orderBy('id', 'desc')->load();
            $this->detail_list_contas->addItems($items);
            
            $panel = new TPanelGroup('Hístorico a Receber', '#f5f5f5');

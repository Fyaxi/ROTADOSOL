...
class ColaboradorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->addFilterField('GrupoPagamento_id', '=', 'GrupoPagamento_id'); // filterField, operator, formField
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Colaborador');
        ...
        $criteria = new TCriteria;
        $criteria->add(new TFilter('id', '=', 2), TExpression::OR_OPERATOR); 
        $grupo_id = new TDBUniqueSearch('grupo_id', 'DBUNIDADE', 'Grupo', 'id', 'nome', 'id', $criteria);
        $grupo_id->setMinLength(0);
        $GrupoPagamento_id = new TDBUniqueSearch('GrupoPagamento_id', 'DBUNIDADE', 'GrupoPagamento', 'id', 'nome');
        $GrupoPagamento_id->setMinLength(0);
        ...
        $this->form->addFields( [ new TLabel('Grupo Pagamento') ], [ $GrupoPagamento_id ] );
        ...
        $this->form->addActionLink('Novo Colaborador', new TAction(['ColaboradorForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['ColaboradorFormView', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);
        $action2 = new TDataGridAction(['ColaboradorForm', 'onEdit'], ['id'=>'{id}']);

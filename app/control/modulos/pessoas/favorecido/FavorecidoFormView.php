 ...
 * 
 */
class FavorecidoFormView extends TPage
{
    protected $form; // form
    ...
    public function __construct($param)
    {
        ...
        $this->form = new BootstrapFormBuilder('form_FavorecidoView');
        ...
        $dropdown->addAction( 'Editar', new TAction(['FavorecidoForm', 'onEdit'],['key'=>$param['key']]), 'far:edit blue');
        ...
        // $container->add(new TXMLBreadCrumb('menu.xml', 'FavorecidoList'));
    ...
    public function onEdit($param)
    {
        try
        {
            ...
            $master_object = new Favorecido($param['key']);
    ...
    public function onGeraEtiqueta($param)
    {
        try
        {
            ...
            TTransaction::open(TSession::getValue('unit_database'));
            $pessoa = new Favorecido($param['key']);

...
class CidadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $estado_id = new TDBUniqueSearch('estado_id', TSession::getValue('unit_database'), 'Estado', 'id', 'uf');
        ...
        $this->form->addActionLink('Inserir Nova Cidade', new TAction(['CidadeForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');

...
class TipoContratoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Inserir Contrato', new TAction(['TipoContratoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $panel = new TPanelGroup('<small>relação de cadastros</small>', 'white');

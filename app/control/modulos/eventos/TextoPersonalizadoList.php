 ...
 * 
 */
class TextoPersonalizadoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_TextoPersonalizado');
        $this->form->setFormTitle('Textos Personalizados');
        ...
        $this->form->addActionLink('Novo Texto Personalizado', new TAction(['TextoPersonalizadoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['TextoPersonalizadoForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);

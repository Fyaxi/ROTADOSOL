 ...
 * 
 */
class VendaCaixaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('VendaCaixa');   // defines the active record
        ...
        $this->form->setFormTitle('Vendas pelo Caixa');
        ...
        $this->form->addActionLink('Inserir Nova Venda', new TAction(['VendaCaixaForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['VendaCaixaForm', 'onEdit'], ['id'=>'{id}']);

...
class VendaCaixaForm extends TWindow
{
    ...
    function __construct($param)
    {
        ...
        $servico_id = new TDBUniqueSearch('list_servico_id[]', 'DBUNIDADE', 'Produto', 'id', 'nome', null, $criteria);
        ...
        $forma_recebimento = new TDBUniqueSearch('list_servico_id2[]', 'DBUNIDADE', 'FormaRecebimento', 'id', 'nome', null, $criteria);

...
class FaturaDashboard extends TPage
{
    ...
    function __construct()
    {
        ...
        try
        {
            ...
            $indicator1->enableSection('main', ['title' => 'Faturamento Mensal', 'icon' => 'calendar-check', 'background' => 'green', 'value' => 'R$ '.number_format($vendas_mes,2,',','.') ] );
            
            $indicator2 = new THtmlRenderer('app/resources/info-box.html');
            $indicator2->enableSection('main', ['title' => 'Faturamento Anual', 'icon' => 'calendar-check', 'background' => 'blue', 'value' => 'R$ '.number_format($vendas_ano,2,',','.') ] );
            ...
            $grafico1->enableSection('main', ['data'   => json_encode($data), 'width'  => '100%', 'height'  => '350px',
                                              'title'  => 'Visualização mês a mês', 'ytitle' => 'Faturado Mensal', 'xtitle' => 'Mês', 'uniqid' => uniqid()]);
            ...
            $grafico2->enableSection('main', ['data'   => json_encode($data), 'width'  => '100%', 'height'  => '350px',
                                              'title'  => 'Visualização ano por ano', 'ytitle' => 'Faturado Anual', 'xtitle' => 'Ano', 'uniqid' => uniqid()]);

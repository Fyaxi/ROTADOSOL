 ...
 * 
 */
class ParametrosList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Parametros');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Parametros');
        ...
        //$this->form->addActionLink('Inserir Novo Parametro', new TAction(['ParametrosForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['ParametrosForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);

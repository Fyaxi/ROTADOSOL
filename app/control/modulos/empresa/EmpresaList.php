...
class EmpresaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Inserir Nova Empresa', new TAction(['EmpresaForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['EmpresaForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);
        $action2 = new TDataGridAction(['EmpresaForm', 'onEdit'], ['id'=>'{id}']);

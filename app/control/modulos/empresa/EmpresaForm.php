...
class EmpresaForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $nome_fantasia->setEditable(FALSE);
    ...
    public static function onChangeEstado($param)
    {
        try
        {
            ...
            if (!empty($param['estado_id']))
            {
                ...
                TDBCombo::reloadFromModel('form_Empresa', 'cidade_id', 'DBUNIDADE', 'Cidade', 'id', '{nome} ({id})', 'nome', $criteria, TRUE);
            }
            else
            {
                TCombo::clearField('form_Empresa', 'cidade_id');
            }
        ...
        try
        {
            ...
            if ($content !== false)
            {
                ...
                if (is_object($cnpj_data) && $cnpj_data->status !== 'ERROR')
                {
                    ...
                    TForm::sendData('form_Empresa', $data, false, true);
                }
                else
                {
                    $data->nome = '';

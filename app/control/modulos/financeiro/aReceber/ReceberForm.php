 ...
 * 
 */
class ReceberForm extends TWindow
{
    protected $form; // form
    protected $fieldlist;
    ...
    function __construct($param)
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_ContaReceberPg');
        ...
        $this->form->addFields( [ new TLabel('Valor Total') ], [ $valor_total ], [ new TLabel('Desconto Concedido') ], [ $desconto ]  );
    ...
    function onEdit($param)
    {
        try
        {
            ...
            if (isset($param['key']))
            {
                ...
                TNumeric::disableField('form_ContaReceberPg', 'valor');
        ...
        try
        {
            ...
            if( !empty($param['list_servico_id']) AND is_array($param['list_servico_id']) )
            {
                if(!empty($param['list_servico_id'][0]))
                {
                    ...
                    // Comparação com valores presentes em tela

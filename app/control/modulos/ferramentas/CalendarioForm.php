...
class CalendarioForm extends TPage
{
    ...
    public static function onSave($param)
    {
        try
        {
            ...
            //$data->data_inicial = TDateTime::convertToMask($data->data_inicial, 'yyyy-mm-dd', ' dd/mm/yyyy'); 
    ...
    public function onEdit($param)
    {
        try
        {
            TDate::disableField('form_event', 'data_inicial');
            TDate::disableField('form_event', 'data_final');
            TCombo::disableField('form_event', 'hora_inicial');
            TCombo::disableField('form_event', 'minuto_inicial');
            TCombo::disableField('form_event', 'hora_final');
            TCombo::disableField('form_event', 'minuto_final');
            ...
            if (isset($param['key']))
            {
                ...
                //$object->inicio = TDateTime::convertToMask($object->inicio, 'dd/mm/yyyy', 'yyyy-mm-dd'); 
